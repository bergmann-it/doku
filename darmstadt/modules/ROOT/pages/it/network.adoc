...
Es gibt verschiedene Wege von außen auf die Infrastruktur zuzugreifen. Details dazu auf der Seite xref:it/services/uplink/remote_access.adoc[Remote access].
...
|6       |50     |xref:it/services/uplink/fallback.adoc[WAN-Fallback] |192.168.6.0/24 |
...
Details zum IPv6 Setup finden sich auf der Seite xref:it/ipv6.adoc[IPv6].

== WLAN

Details zum wlan finden sich auf einer extra Seite: xref:it/services/wifi.adoc[Wifi]

== DNS

Details zum DNS setup findet sich auf der Seite xref:it/services/dns.adoc[DNS]
...
|AP EG                                     |192.168.1.241     |xref:it/services/wifi.adoc[Wifi]
|AP OG1                                    |192.168.1.242     |xref:it/services/wifi.adoc[Wifi]
...
|ATA Adapter  |link:https://192.168.2.243/[192.168.2.243]     |xref:it/services/telefon.adoc[Telefon]
|DECT-Basis  |link:https://192.168.2.242/[192.168.2.242]     |xref:it/services/telefon.adoc[Telefon]
|Klingel  |link:https://192.168.2.241/[192.168.2.241]     |xref:it/services/zutritt.adoc#_hoftorklingel[Klingel]
|=== 
...
|xref:it/services/uplink/fallback.adoc[WAN-Fallback-Router]                       |192.168.6.1       |
|Router                                    |192.168.6.2       |
|=== 
...
|Homepi                                    |192.168.8.16     |/32 |xref:it/homepi.adoc[Homepi]
