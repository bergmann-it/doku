...
|DECT-Basis   |W52P             |3 W
2+|xref:da::it/homepi.adoc[Homepi] |12 W
2+|Summe                        |ca. 45 W 
|===
...
Im Falle eines DSL-Ausfalls kann das Netz über den xref:da::it/services/uplink/fallback.adoc[WAN-Fallback-Router] weiter betrieben werden.
