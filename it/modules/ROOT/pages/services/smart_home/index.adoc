...
An den Fenstern sind elektrische Rolläden verbaut. An jedem Rolladen ist ein link:https://www.zigbee2mqtt.io/devices/MS-108ZR.html[Moes MS-108ZR] angeschlossen. Neben der Steuerung über die Hausautomatisierung ist bei allen Rolläden auch eine Funk-Ferbedienung angelernt. Diese funktioniert unabhängig von der Hausautomatisierung.
...
INFO: Bis jetzt funktioniert die Einbindung in die Hausautomatisierung noch nicht.
